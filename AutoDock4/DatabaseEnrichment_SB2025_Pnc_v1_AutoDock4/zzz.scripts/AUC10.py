# This script reads in a rank sorted list of actives and decoys and plots the ROC curve and calculates AUC 
# Written by: C Corbo
...
with open('All_score_complt_sort_10.txt') as file_object:
   lines = file_object.readlines()

   for line in lines:
      stripline = line.rstrip()
      splitline = stripline.split() 
      ranklist.append(splitline[0])
      #ADDED
      scorelist.append(splitline[1])
