...
ligand_atom_file                                             ${sys}.${conditions_ad4_pr}.docking.noH.mol2
...
ligand_outfile_prefix                                        ${sys}.${conditions_ad4_pr}.dockingRMSD
...
grep "HA_RMSDh:"  ${sys}.${conditions_ad4_pr}.dockingRMSD_scored.mol2 | awk '{print $3}' >> RMSDh_grep.txt
