...
if [ $mpi_dir == "No" ];then
  ${dock_dir}/bin/dock6 -i FLX_decoys_submit.in -o FLX_decoys_submit.out
else 
  ${mpi_dir}/bin/mpirun -np ${processes} ${dock_dir}/bin/dock6.mpi -i FLX_decoys_submit.in -o FLX_decoys_submit.out
fi
